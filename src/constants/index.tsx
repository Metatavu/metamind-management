...
export const SET_KNOT_POSITIONS ="SET_KNOT_POSITIONS";
export type SET_KNOT_POSITIONS = typeof SET_KNOT_POSITIONS;

export const GET_KNOT_POSITIONS ="GET_KNOT_POSITIONS";
export type GET_KNOT_POSITIONS = typeof GET_KNOT_POSITIONS;
